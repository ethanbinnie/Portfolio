...
const allContent: { [key: string]: Content } = {
  ...
  Walmart: {
    ...
    techStack: ["Next.js", "Oxylabs", "Tailwind", "Javascript"],
    description:
      "Creating a Walmart clone taught me how to build a scalable e-commerce platform. With a focus on intuitive navigation, easy search functionalities, and streamlined checkout processes, it aims to deliver a user-friendly interface that prioritises efficiency and convenience. Through building this clone I gained insights into the importance of UX design and it enhanced my proficiency in frontend development.",
    image: "walmartSS.png",
    date: "Apr 2024",
  },
  Spotify: {
