...
const allContent: { [key: string]: Content } = {
  ...
  Wordle: {
    ...
    description: "This build replicates the simplicity of the popular game Wordle. Using fundamental JavaScript and HTML/CSS, the game features a minimalistic design, intuitive user interface and responsive gameplay. This build taught me foundational skills in Javascript for handling user interactions. I also gained experience in game logic implementation, such as generating random words and validating user inputs.",
    image: "wordleSS.png",
    date: "Nov 2023",
  },
  Walmart: {
    title: "Walmart",
    techStack: ["Next.js", "Oxylabs", "Tailwind", "Javascript"],
    description: "Creating a Walmart clone taught me how to build a scalable e-commerce platform. With a focus on intuitive navigation, easy search functionalities, and streamlined checkout processes, it aims to deliver a user-friendly interface that prioritizes efficiency and convenience. Through building this clone I gained insights into the importance of UX design and it enhanced my proficiency in frontend development.",
    image: "walmartSS.png",
    date: "Apr 2024",
  },
  Spotify: {
