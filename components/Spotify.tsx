            ...
            >
              ...
              >
                <li className="ml-4 mb-1">
                  Aimed to replicate the visual design and layout of Spotify.
                </li>
                <li className="ml-4 mb-1">
                  Focused on creating a frontend interface closely resembling
                  the original application.
                </li>
                <li className="ml-4 mb-1">
                  Provided hands-on experience in mimicking real-world
                  application UI&apos;s.
                </li>
                <li className="ml-4 mb-1">
                  Applied principles specific to Spotify to achieve an authentic
                  replication.
                </li>
                <li className="ml-4">
                  Enhanced skills in <br className="hidden md:inline"></br>{" "}
                  creating <br className="md:hidden"></br> visually
                  <br className="hidden md:inline"></br> appealing{" "}
                  <br className="md:hidden"></br>web designs.
                </li>
              </ul>
              <h1
